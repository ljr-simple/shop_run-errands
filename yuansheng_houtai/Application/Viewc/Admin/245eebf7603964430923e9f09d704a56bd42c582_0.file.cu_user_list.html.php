...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <br />
        <p class="text-right text-gray">基于<a class="text-gray" target="_blank"
                href="index.php?p=Admin&c=Users&a=del&proid=<?php echo $_smarty_tpl->tpl_vars['rows']->value['user_id'];?>
">Person</a>构建</p>
    </div>
</body>
